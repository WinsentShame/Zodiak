...
public sealed unsafe class remote_player_normal_tick : hook_group
{
    private static entity_tick_sig original;

    protected override string NAME => "remote_player_normal_tick";
    protected override nint TARGET_OFFSET => OFFSETS.FUNC.REMOTEPLAYER_NORMALTICK;
